...
public class Unique1
{
   ...
   public void getNumbers()
   {
      ...
      ///ANSWER
      int[] numbers = new int[30]; //array of five elements
      int enteredNum; // counter for number input
      
      while( count != 30 ) // limits the unique number count to 30
      {
         System.out.print( "\nEnter number: " );
         ...
         ///ANSWER
         if (enteredNum >= 10 && enteredNum <= 500){
            ...
            System.out.println( "number must be between 10 and 500" );
