...
public class Unique3
{
   ...
   public void getNumbers()
   {
      ...
      int arrayCount = 0; // array size of variable
      System.out.print("Enter size of array: "); // prompts user for input of array size
      arrayCount = input.nextInt(); // assigns input to variable
      
      ///ANSWER
      int[] numbers = new int[arrayCount]; //array based on the input
      int enteredNum; // counter for number input
      
      while( count != arrayCount ) // if statement to limit the unique values to the size of array
      {
         System.out.print( "\nEnter number: " );
